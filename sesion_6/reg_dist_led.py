...
- Conectar el sensor HC-SR04 a los pines GPIO de la Raspberry Pi (TRIG=23, ECHO=24 con divisor de voltaje 5V→3.3V).

- Conectar los cuatro LEDs (verde, amarillo, naranja y rojo) a los pines GPIO17, GPIO27, GPIO22 y GPIO5 respectivamente, cada uno con su resistencia a GND.

- Verificar las conexiones de alimentación y tierra comunes.


2. Configuración del entorno

- Abrir Thonny en la Raspberry Pi.

- Crear una carpeta de proyecto (por ejemplo, Practica_Distancia_Flask_ThingSpeak).

- Guardar el archivo Python (app.py) proporcionado.

- Confirmar de tener instalado Flask y requests:
sudo apt install python3-flask python3-requests -y


3. Configuración de ThingSpeak

- Ingresar a https://thingspeak.com y crear una cuenta gratuita.

- Crear un nuevo canal con al menos un campo (“Field 1”).

- Copiar tu Write API Key y reemplázala en el código (THINGSPEAK_API_KEY = "TU_CLAVE").

- Si el canal es público, copia el CHANNEL_ID para incrustar la gráfica en la web local.


4. Ejecución del sistema

- Ejecutar el programa en Thonny (Run ▶ o F5).

- En el navegador de la Raspberry Pi (o desde otro equipo en la misma red), abre:
http://<IP_DE_TU_PI>:5000

- Se visualizara un panel web con:
...
- Acercar o alejar un objeto frente al sensor y observa:
